...
Route::get('/', function () { 
    ...
    // 1. Fetch real events for landing page
    $events = Event::with('category')->orderBy('Event_Date', 'asc')->take(3)->get();

    // 2. Fetch real Giving Impact percentages from Finance Database
